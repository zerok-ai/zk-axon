...
const (
	...
	GetTraceQuery                         = "SELECT count(*) OVER() AS total_rows, trace_id, issue_hash, incident_collection_time from incident where issue_hash=$1 LIMIT $2 OFFSET $3"
