...
const (
	...
	GetTraceQueryByScenarioId             = "SELECT CASE WHEN $1 then COUNT(*) OVER() ELSE 0 END AS total_rows, trace_id, issue_hash, incident_collection_time from incident where issue_hash=$2 ORDER BY incident_collection_time DESC LIMIT $3 OFFSET $4"
